...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDENTE', 'EM_ANALISE', 'APROVADA', 'RECUSADA', 'PLANEJADA', 'AGUARDANDO_SUPRIMENTOS', 'CONTRATADA', 'EM_EXECUCAO', 'AGUARDANDO_MATERIAL', 'CONCLUIDA', 'CANCELADA');
